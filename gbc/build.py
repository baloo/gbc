...
class Builder(object):
    ...
    def stable(self):
        ...
        for i in targets:
            ...
            self.config.read_debian_config()
            ...
            if not self._is_build(ref):
                try:
                    ...
                    files = self._build(upstream_branch, debian_branch, debian_version, output, upstream_branch=False)
        ...
        for i in targets:
            ...
            if not self._is_build(ref):
                try:
                    ...
                    files = self._build(i.name, debian_branch, debian_version[7:], output, upstream_branch=False, dch_distrib=self.config.dch["dists"].get("testing", "testing"))
        ...
        for i in targets:
            ...
            if not self._is_build(ref):
                ...
                try:
                    ...
                    files = self._build(i, branch, debian_version, output, dch_distrib=self.config.dch["dists"].get("unstable", "unstable"))
    ...
    def _build(self, upstream, debian, debian_version, output, dch_distrib = None, upstream_branch=True):
